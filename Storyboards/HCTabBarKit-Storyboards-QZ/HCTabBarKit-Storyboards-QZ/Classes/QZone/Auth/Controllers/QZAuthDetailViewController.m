...
@interface QZAuthDetailViewController ()
...
@implementation QZAuthDetailViewController
...
- (void)viewDidLoad {
    ...
    self.title = [NSString stringWithFormat:@"%@-%ld", @"动态-详细", self.bullB.index + 1];
}

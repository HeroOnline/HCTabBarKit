...
- (void)hc_initialize {
    ...
    HCLog(@"QZTabBarController # hc_initialize # ...");
    ...
    dict1[HCTabBarButtonNormalImageAttributeName] = [UIImage imageNamed:@"tabbar_icon_auth"];
    
    
    dict1[HCTabBarButtonSelectedImageAttributeName] = [UIImage imageNamed:@"tabbar_icon_auth_click"];
    ...
    hc_tabBar.tabBarHandleRequireCertificationAuthorityBlock = ^(NSInteger willSelectIndex, NSInteger originalIndex) {
        ...
        if (willSelectIndex == 3) {
            ...
            if (user.loginState) {
                ...
                QZLoginViewController *vc = [nc.viewControllers firstObject];

...
@interface UIImage (HCTabBarKit)

/**
 *  拉伸图片
 *
 *  @author HeroCao , heroonlinecao@gmail.com , 15-08-02 15:08:21
 *
 *  @param image 原图片
 *
 *  @return 拉伸之后的图片
...
+ (instancetype)imageForAdaptedWithImageName:(NSString *)imageName;

+ (instancetype)imageForAdaptedWithImageName:(NSString *)imageName isOriginalRendering:(BOOL)isOriginalRendering;
